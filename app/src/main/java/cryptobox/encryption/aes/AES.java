package cryptobox.encryption.aes;
...
import cryptobox.encryption.SymmetricAlg;
...
public class AES implements SymmetricAlg {
     ...
     * @param key           The provided secret key. (user password)
     ...
     *
     * @param textToDecrypt The encrypted text to decrypt.
     * @param key           The secret key that HAS TO MATCH the key that used in the encryption process.
